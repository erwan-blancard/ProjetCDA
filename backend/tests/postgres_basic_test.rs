...
async fn test_postgres_connection() {
    ...
    println!("🔗 Test de connexion à PostgreSQL avec l'URL: {}", database_url);
...
async fn test_postgres_full_workflow() {
    ...
    println!("🚀 Test complet PostgreSQL - Démarrage");
    ...
    println!("🎉 Test complet PostgreSQL - SUCCÈS !");
} 